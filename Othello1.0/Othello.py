...
def squares():
    boardList=[i for i in range(11, 89) if 1 <= (i % 10) <= 8]
    return boardList
squares()
def initial_board():
    board = [OUTER] * 100
...
def minimax_searcher(depth, evaluate,board,player):
    ...
    return strategy(player,board)
#print(print_board(board))
#print(minimax_searcher(6,weighted_score))
...
def play(black_strategy, white_strategy):
    ...
    while player is not None:
        if player==WHITE:
            ...
            print(print_board(board))
            move=alphabeta_searcher(3,weighted_score,board,player)

        else:
            print("Choose your move.....................................................")
            move = get_move(strategy(player), player, board)
        make_move(move, player, board)
        black,white=score(player, board)
        print("Black:",black,"White:",white)
        player = next_player(board, player)
    return board, score(BLACK, board)
final_board,final_score=play(human_strategy,minimax_searcher)
